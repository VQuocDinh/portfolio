...
export const en = {
  ...
  recruiterLetter: {
    ...
    p1: "Thank you for taking the time to review my profile. I truly appreciate recruiters and hiring teams who invest effort in understanding candidates beyond a résumé.",
    p2: "I am passionate about building reliable, user-centered web products with React, TypeScript, and Node/NestJS — and I enjoy collaborating in teams that value clear communication and quality.",
    p3: "If you see a fit for your role or team, I would be glad to connect. Wishing you a smooth hiring process and meaningful conversations with every candidate you meet.",
  ...
  about: {
    ...
    title: "About Me",
    subtitle:
      "Results-driven developer focused on performance, scalability, and maintainable code.",
    p1: "I am a Fullstack Developer (ReactJS & NestJS) with 2+ years of experience building stable, high-performance web systems across EdTech and enterprise products. I optimize delivery by leveraging AI tools such as GitHub Copilot and Cursor to accelerate feature work by an estimated 30–40%, while keeping a strong problem-solving mindset and technical leadership in startup environments.",
    p2: "I care about streamlined, elegant, yet robust products: proven impact on performance (including significant application and API improvements), maintainable TypeScript codebases, and great user experiences with PostgreSQL, Prisma/ORM, and Next.js where it fits.",
  ...
  skills: {
    ...
    subtitle:
      "A curated stack for modern web development — from UI to infrastructure.",
    categories: {
      frontend: "Frontend",
      backend: "Backend",
      mobile: "Mobile",
  ...
  experience: {
    ...
    subtitle:
      "Professional journey and measurable impact across teams and products.",
  ...
  projects: {
    ...
    title: "Key Projects",
    subtitle:
      "Selected work — architecture, scalability, and attention to detail.",
  ...
  contactThankYou: {
    ...
    messagePersonal:
      "Thanks for reaching out, {name}! Your message has been received — I truly appreciate your interest.",
    responseTime:
      "I usually reply within 24 hours. Looking forward to connecting with you!",
